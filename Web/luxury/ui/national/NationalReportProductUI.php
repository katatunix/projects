...
?>
		...
		<table border="1" cellpadding="4" cellspacing="0" width="100%" style="font-size: 1.0em">
			<thead>
			<tr>
				<th>Resort</th>
				<th><?= $isRoom ? 'Room name' : 'Food or beverage name' ?></th>
				<th><?= $isRoom ? 'Price/day' : 'Unit price' ?></th>
				<th><?= $isRoom ? 'Occup. days' : 'Quantity of sell items' ?></th>
<?php
				if ($hasOccupancyRate) {
?>
					<th>Occup. rate</th>
...
?>
				<tr>
					<td><?= htmlspecialchars( $prod->resortName ) ?></td>
