...
namespace PLog
{
	...
	public partial class FormMain : Form, IAdbObserver
	{
		...
		private void refreshDevsList()
		{
			...
			if (devs == null)
			{
				MessageBox.Show(this, "Please install Tizen SDK correctly!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
				return;
			}
        ...
        private void buttonClearC_Click(object sender, EventArgs e)
        {
            ...
            bool isRunning = AdbConnector.getInstance().getSessionId() > -1;
